...
import { LoginTooltip, handleTooltipHide, handleTooltipShow } from './LoginTooltip';
                ...
                <div className='absolute w-full top-[20%] p-4 md:p-8'>
                    ...
                    <div className='my-4 '>
                        ...
                        <button
                            ...
                            className='border  text-white border-gray-300 hover:bg-gray-300 hover:bg-opacity-10 py-2 px-5 ml-4'
                        >
                            Watch Later
                        </button>
